  ...
  const cardData =[
    {
      ...
      desc: 'Polymerase chain reaction (PCR) is a wet lab technique used to duplicate DNA. It has several uses, such as in COVID testing, but it is a difficult technique to conduct due to its sensitivity. We aim to automate this technique so that its efficiency can be maximized and failed attempts minimized.',
      git:"apple.com", 
      gantt:"costco.com",
      finished:0,
      video: pcrVid,
